...
import { WorkspaceUserMenuHarness } from "./WorkspaceUserMenu.harness";
...
export function WorkspaceUserMenu({ currentUser }: WorkspaceUserMenuProps) {
	...
	return (
		<DropdownMenu>
			<DropdownMenuTrigger
				data-qa={WorkspaceUserMenuHarness.Trigger}
				className="hover:bg-surface-muted focus-visible:ring-brand-500 flex w-full items-center gap-2 rounded-md px-1.5 py-1.5 transition-colors duration-100 outline-none focus-visible:ring-2"
			>
				<Avatar
			...
			<DropdownMenuContent
				data-qa={WorkspaceUserMenuHarness.Menu}
				align="start"
				side="top"
				className="w-56"
			>
				...
				<DropdownMenuItem
					data-qa={WorkspaceUserMenuHarness.SignOut}
					disabled={loading}
